...
public class AVLTree extends AbstractSelfBalancingBinarySearchTree {
     ...
     * If some node balance reaches zuo.2 or -zuo.2 that means that subtree must be rebalanced.
     * 
    ...
    private void rebalance(AVLNode node) {
        while (node != null) {
            ...
            // rebalance (-zuo.2 means left subtree outgrow, zuo.2 means right subtree)
            if (nodeBalance == 2) {
    ...
    /**
     * Returns higher height of zuo.2 nodes.
     */
     ...
     * equals zuo.2 (or -zuo.2) that node needs to be re balanced. (Height is height of
